        ...
        <div class="card overflowhidden number-chart">
            <div class="body">
                <div class="number">
                    ...
                    <span>{{$WareHouse->acreage }} m3</span>
                </div>
                <!-- Model -->
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal{{$WareHouse->id}}">Chỉnh Sửa</button>
            <!-- Modal -->
              <div class="modal fade" id="myModal{{$WareHouse->id}}" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Chỉnh Sửa Kho: {{$WareHouse->name}}</h4>
                    </div>
                    <div class="modal-body">
                        <form id="basic-form" action={{route('dashboard.editwarehouse')}} method="post" novalidate="">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="idWareHouse" value="{{$WareHouse->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" required="" name="acreage" value="{{$WareHouse->acreage}}">
                    </div>
                    <div class="form-group">
                        <label>Kích hoạt</label>
                        <br>
                        <label class="fancy-radio">
                            <input type="radio" name="activated" value="activated" required="" checked data-parsley-errors-container="#error-radio" data-parsley-multiple="gender">
                            <span><i></i>Có</span>
                        </label>
                        <label class="fancy-radio">
                            <input type="radio" name="activated" value="nonActivated" data-parsley-multiple="gender">
                            <span><i></i>Không</span>
                        </label>
                        <p id="error-radio"></p>
                    </div>
            ...
            <table id="customers">
              <tbody><tr>
                <th colspan="2">Dự án</th>
                <th>MG - M3</th>
              </tr>
              <tr>
                <td colspan="2"><a href="#" title="Alfreds FutterkisteAlfreds FutterkisteAlfreds Futterkiste">Alfreds Futterkiste</a></td>
                <td>12 - 0 </td>
                <td>
                    <button  id="" type="button" class="btn btn-danger">Sửa</button>
                </td>
              </tr>
              <tr>
                <td colspan="2"><a href="#" title="Alfreds FutterkisteAlfreds FutterkisteAlfreds Futterkiste">Alfreds Futterkiste</a></td>
...
<div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card overflowhidden number-chart">
            <div class="body" style="text-align: center;">
                 <button type="button" id="addInventory"  class="btn btn-success">Thêm kho</button>
            </div>
...
<div class="row clearfix" id="contentAddInventory" style="display: none;">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <form id="basic-form" action={{route('dashboard.addwarehouse')}} method="post" novalidate="">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="form-group">
                        <label>Tên kho</label>
                    ...
                    <div class="form-group">
                        <label>Diện tích</label>
                        <input type="number" class="form-control" required="" name="acreage">
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <!-- <div class="form-group">
                        ...
                        </select><div class="btn-group"><button type="button" class="multiselect dropdown-toggle btn btn-default" data-toggle="dropdown" title="Tomatoes, Mozzarella" aria-expanded="false"><span class="multiselect-selected-text">Tomatoes, Mozzarella</span> <b class="caret"></b></button><ul class="multiselect-container dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;"><li><a tabindex="0"><label class="checkbox"><input type="checkbox" value="cheese"> Cheese</label></a></li><li class="active"><a tabindex="0"><label class="checkbox"><input type="checkbox" value="tomatoes"> Tomatoes</label></a></li><li class="active"><a tabindex="0"><label class="checkbox"><input type="checkbox" value="mozarella"> Mozzarella</label></a></li><li><a tabindex="0"><label class="checkbox"><input type="checkbox" value="mushrooms"> Mushrooms</label></a></li><li><a tabindex="0"><label class="checkbox"><input type="checkbox" value="pepperoni"> Pepperoni</label></a></li><li><a tabindex="0"><label class="checkbox"><input type="checkbox" value="onions"> Onions</label></a></li></ul></div>
...
<!-- thêm công ty ở đây -->
<div class="row clearfix" id="contentAddCategory" style="display: none;">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>Thêm công ty</h2>
            ...
            <div class="body">
                <form id="basic-form" method="post" novalidate="">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <label class="fancy-radio">
                            <input type="radio" name="gender" value="male" required="" checked data-parsley-errors-container="#error-radio" data-parsley-multiple="gender">
                            <span><i></i>Có</span>
                        </label>
                        <label class="fancy-radio">
...
$(document).ready(function(){
  ...
  $(".addCategory").click(function(){
    console.log("id",$(this).attr('data-idCategory'));
     $("#contentAddCategory").slideToggle();
     $("#contentAddInventory").hide();
    $("HTML, BODY").animate({scrollTop: $("#contentAddCategory").offset().top - 100}, 1000);
  });
  $('#food').multiselect();
});
</script>
                ...
                <ul class="right_chat list-unstyled mb-0">
                    <li class="offline">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/assets/img/xs/avatar2.jpg" alt="">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/assets/img/xs/avatar3.jpg" alt="">
                                <div class="media-body">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/assets/img/xs/avatar4.jpg" alt="">
                                <div class="media-body">
                ...
                <div class="timeline-item blue" date-is="19-04-2018 - Yesterday">
                    ...
                    <div class="msg">
                        ...
                        <div class="timeline_img m-b-20">
                            <img class="w-25" src="{{url('/')}}/assets/img/blog/blog-page-4.jpg" alt="Awesome Image">
                            <img class="w-25" src="{{url('/')}}/assets/img/blog/blog-page-2.jpg" alt="Awesome Image">
                        </div>
                        <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
